 ...
 * {@link WebSocketRequirement} instances into the route registry of {@link CraftsNet}.
 *
...
public class WebSocketRequirementAutoRegisterHandler extends AutoRegisterHandler<WebSocketRequirement<? extends RequireAble>> {
     ...
     *
     * <p>This method attempts to register the given {@link WebSocketRequirement} with the {@link CraftsNet#routeRegistry()}
    ...
    protected boolean handle(WebSocketRequirement<? extends RequireAble> webSocketRequirement, Object... args) {
        try {
            craftsNet.routeRegistry().registerRequirement(webSocketRequirement);
            return true;
        } catch (Exception e) {
