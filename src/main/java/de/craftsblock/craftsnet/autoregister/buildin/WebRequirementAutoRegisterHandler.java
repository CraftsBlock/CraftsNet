 ...
 * {@link WebRequirement} instances into the route registry of {@link CraftsNet}.
 *
...
public class WebRequirementAutoRegisterHandler extends AutoRegisterHandler<WebRequirement> {
     ...
     *
     * <p>This method attempts to register the given {@link WebRequirement} with the {@link CraftsNet#routeRegistry()}
    ...
    protected boolean handle(WebRequirement webRequirement, Object... args) {
        try {
            craftsNet.routeRegistry().registerRequirement(webRequirement, true);
            return true;
        } catch (Exception e) {
